...
make sure to add numbers for limits, things like how tall/much grass/snow/leaves/etc you can have and for how long you can violate it. make sure every section has the numbers necessary listed unless the numbers are unknown. If you do not have the numbers do not display them or create new onws.
